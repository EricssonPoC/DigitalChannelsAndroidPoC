...
fun CharSequence.firstIndexOf(childString: String): Int {
    return this.indexOf(childString).orZero()
}

fun CharSequence.lastIndexOf(childString: String): Int {
    return this.indexOf(childString).plus(childString.length).orZero()
}
